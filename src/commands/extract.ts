...
import { BrunoParser } from '../services/bruno/brunoConfigManager.js';
import { CollectionGenerator } from '../services/bruno/brunoCollectionFileGen.js';
import { BrunoConfigManager } from '../services/brunoConfigManager.js';
...
export default class Extract extends Command {
    ...
    async run(): Promise<void> {
        ...
        try {
            ...
            const secrets = await parser.collectSecrets();
